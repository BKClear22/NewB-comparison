...
export default function StickyCallButton() {
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white md:hidden">
        <Link
      ...
      <div className="hidden md:block fixed bottom-6 right-6 z-50">
        <Link
          href="tel:+18449893190"
          className="flex items-center gap-3 bg-[#4CAF50] hover:bg-[#388E3C] text-white px-6 py-4 rounded-full transition-all text-lg font-bold shadow-2xl hover:shadow-[#4CAF50]/50 hover:scale-110"
        >
          <svg
            className="w-6 h-6"
            fill="none"
